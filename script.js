...
const apiKey = "EmWUqdkW7u5OoBZGzgEyyfo7p98vqjDLyxWt8Va9d8oR5dEq4shpeq3D";
const perPage = 15;
let currentPage = 1;
let searchTerm = null;

const downloadImg = (imgUrl, fileName) => {
    ...
    imageWrapper.innerHTML += images.map(img =>
        `<li class="card">
            ...
            <div class="details">
                ...
                <button onclick="downloadImg('${img.src.large2x}', '${img.photographer}.jpg');">
